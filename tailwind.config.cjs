  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        'no-webp__hero--page-detail-xmed': "url('/images/hero-page-detail_xmed.jpg')",
        ...
        'hero--about': "url('/images/hero-about.webp')",
        'no-webp__hero--about': "url('/images/hero-about.jpg')",
        'hero--about-xmed': "url('/images/hero-about_xmed.webp')",
        'no-webp__hero--about-xmed': "url('/images/hero-about_xmed.jpg')",
        ...
        'hero--offers': "url('/images/hero-offers-large_2400.webp')",
        'no-webp__hero--offers': "url('/images/hero-offers-large_2400.jpg')",
        'hero--offers-xmed': "url('/images/hero-offers_xmed_600.webp')",
        'no-webp__hero--offers-xmed': "url('/images/hero-offers_xmed_600.jpg')"
      },
      backgroundPosition: {
