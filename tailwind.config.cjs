  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        'hero--page-faq': "url('/images/hero-page-faq.webp')",
        'no-webp__hero--page-faq': "url('/images/hero-page-faq.jpg')",
        'hero--page-faq-xmed': "url('/images/hero-page-faq_xmed.webp')",
        'no-webp__hero--page-faq-xmed': "url('/images/hero-page-faq_xmed.jpg')",
